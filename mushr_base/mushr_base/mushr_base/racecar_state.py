...
class RacecarState(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("vesc.speed_to_erpm_gain", -3500.0)
        self.declare_parameter("vesc.steering_angle_to_servo_offset", 0.5)
        self.declare_parameter("vesc.steering_angle_to_servo_gain", 0.8)
        self.declare_parameter("vesc.chassis_length", 0.3)
        self.declare_parameter("vesc.wheelbase", 0.29)
