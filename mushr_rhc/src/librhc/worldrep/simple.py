...
class Simple:
    def __init__(self, node, dtype, map):
        ...
        self.dtype = dtype
        self.map = map
        self.perm_reg = utils.map.load_permissible_region(self.node, self.map)
    ...
    def reset(self):
        ...
        self.epsilon = self.node.get_float("world_rep/epsilon", default=0.5)
        ...
        self.car_length = self.node.get_float("world_rep/car_length", default=0.5)
        self.car_width = self.node.get_float("world_rep/car_width", default=0.3)
