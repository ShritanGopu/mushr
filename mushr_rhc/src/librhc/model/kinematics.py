...
class Kinematics:
    ...
    def reset(self):
        self.set_k(self.node.get_int("K", default=62))
    ...
    def set_k(self, k):
        ...
        """
        self.K = k
        self.wheel_base = self.node.get_float("model/wheel_base", default=0.29)

        time_horizon = utils.get_time_horizon(self.node)
        T = self.node.get_int("T", default=15)
